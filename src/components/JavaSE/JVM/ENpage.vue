...
export default {
    ...
    methods:{
        clickKnow(value){
            ...
            switch(value){
                case 1:$('.first-title').css('background-color','#67C23A');this.knowPush("Java Memory");break;
                case 2:$('.second-title').css('background-color','#67C23A');this.knowPush("Method Area");break;
                case 3:$('.third-title').css('background-color','#67C23A');this.knowPush("Program Counter Register");break;
                case 4:$('.forth-title').css('background-color','#67C23A');this.knowPush("Native Method Stacks");break;
            }
        ...
        clickUnknow(value){
            ...
            switch(value){
                case 1:$('.first-title').css('background-color','#E6A23C');this.unknowPush("Java Memory");break;
                case 2:$('.second-title').css('background-color','#E6A23C');this.unknowPush("Method Area");break;
                case 3:$('.third-title').css('background-color','#E6A23C');this.unknowPush("Program Counter Register");break;
                case 4:$('.forth-title').css('background-color','#E6A23C');this.unknowPush("Native Method Stacks");break;
            }
        ...
        clickNote(value){
            switch(value){
                case 1:this.$emit('note','Java Memory');break;
                case 2:this.$emit('note','Method Area');break;
                case 3:this.$emit('note','Program Counter Register');break;
                case 4:this.$emit('note','Native Method Stacks');break;
            }
        },
        nextPage(){
