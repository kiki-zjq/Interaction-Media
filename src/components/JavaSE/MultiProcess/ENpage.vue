...
export default {
    ...
    methods:{
        clickKnow(value){
            ...
            switch(value){
                case 1:$('.first-title').css('background-color','#67C23A');this.knowPush("Processes and Threads");break;
                case 2:$('.second-title').css('background-color','#67C23A');this.knowPush("Concurrency and Parallelism");break;
                case 3:$('.third-title').css('background-color','#67C23A');this.knowPush("Thread Class");break;
                case 4:$('.forth-title').css('background-color','#67C23A');this.knowPush("Dead Lock");break;
            }
        ...
        clickUnknow(value){
            ...
            switch(value){
                case 1:$('.first-title').css('background-color','#E6A23C');this.unknowPush("Processes and Threads");break;
                case 2:$('.second-title').css('background-color','#E6A23C');this.unknowPush("Concurrency and Parallelism");break;
                case 3:$('.third-title').css('background-color','#E6A23C');this.unknowPush("Thread Class");break;
                case 4:$('.forth-title').css('background-color','#E6A23C');this.unknowPush("Dead Lock");break;
            }
        ...
        clickNote(value){
            switch(value){
                case 1:this.$emit('note','Processes and Threads');break;
                case 2:this.$emit('note','Concurrency and Parallelism');break;
                case 3:this.$emit('note','Thread Class');break;
                case 4:this.$emit('note','Dead Lock');break;
            }
        },
        nextPage(){
            this.$router.push('/JavaSE/DataStructure#header');
        }
