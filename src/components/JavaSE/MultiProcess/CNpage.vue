...
export default {
    ...
    methods:{
        clickKnow(value){
            ...
            switch(value){
                case 1:$('.first-title').css('background-color','#67C23A');this.knowPush("进程与线程");break;
                case 2:$('.second-title').css('background-color','#67C23A');this.knowPush("并发与并行");break;
                case 3:$('.third-title').css('background-color','#67C23A');this.knowPush("Thread类");break;
                case 4:$('.forth-title').css('background-color','#67C23A');this.knowPush("死锁");break;
            }
        ...
        clickUnknow(value){
            ...
            switch(value){
                case 1:$('.first-title').css('background-color','#E6A23C');this.unknowPush("进程与线程");break;
                case 2:$('.second-title').css('background-color','#E6A23C');this.unknowPush("并发与并行");break;
                case 3:$('.third-title').css('background-color','#E6A23C');this.unknowPush("Thread类");break;
                case 4:$('.forth-title').css('background-color','#E6A23C');this.unknowPush("死锁");break;
            }
        ...
        clickNote(value){
            switch(value){
                case 1:this.$emit('note','进程与线程');break;
                case 2:this.$emit('note','并发与并行');break;
                case 3:this.$emit('note','Thread类');break;
                case 4:this.$emit('note','死锁');break;
            }
        },
        nextPage(){
